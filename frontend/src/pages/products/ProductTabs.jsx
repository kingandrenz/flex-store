...
import { useCreateReviewMutation, useGetTopProductsQuery } from '../../redux/api/productApiSlice'
              ...
              <form onSubmit={submitHandler}>
                <div className="my-2">
                  ...
                  <select id="rating" required value={rating} onChange={e => setRating(e.target.value)}
                   className='p-2 border roundeg-lg xl:w-[40rem] text-black'>
                ...
                <div className="my-2">
                  ...
                  <textarea id="comment" rows='3' required value={comment} onChange={(e)=> setComment(e.target.value)}
                    className='p-2 border roundeg-lg xl:w-[40rem] text-black'></textarea>
                </div>

                <button type='submit' disabled={loadingProductReveiw} 
                className='bg-blue-600 text-white py-2 px-4 rounded-lg'>Submit Review</button>
              </form>
            ): (
