...
function AllProducts() {
    ...
    if (isLoading) {
        return (<div className="ml-40 p-4"><Loader /></div>)
    }
    if (isError) {
                        ...
                        >
                            <div className="flex">
                                ...
                                <div className="p-4 flex flex-col justify-around">
                                    ...
                                    <p className="text-gray xl-w[30rem] md:w-[20rem] sm:w-[10rem] text-sm mb-4 ">
                                        {product?.description?.substring(0, 160)}...
                                    </p>

                                    <div className="flex justify-between">
                                        <Link to={`/admin/product/update/${product._id}`}  className="inline-flex
                                        ...
                                        dark:focus:ring-blue-800">Update Product
                                        <svg 
